...
* @{
*/
#define PRODUCT_KEY "6a6039c89b174497a2570fdc4578f4e0"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "3d24d83d7ce144e590989dd8946cdfba"
...
*/
#define C2H5OH_LEN                           1
#define fire_sensor_LEN                           1
#define temp_alert_LEN                           1
#define humi_alert_LEN                           1
...
typedef struct {
  bool valueC2H5OH;
  bool valuefire_sensor;
  bool valuetemp_alert;
  bool valuehumi_alert;
  uint32_t valuetemp;
  uint32_t valuehumi;
} dataPoint_t;
...
/** User Area Device State Structure */
typedef struct {
  uint8_t flagC2H5OH:1;
  uint8_t flagfire_sensor:1;
  uint8_t flagtemp_alert:1;
  uint8_t flaghumi_alert:1;
  uint8_t flagtemp:1;
  uint8_t flaghumi:1;
} dataPointFlags_t;
